...
```shell
git clone https://github.com/common-again/Qubt-testevhnn
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/Qubt-testevhnn/` (actual URL will be outputted in the CLI) in a browser.
...
`hugo.yaml`:
```yaml
baseURL: 'https://common-again.github.io/Qubt-testevhnn'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/common-again/Qubt-testevhnn
  - link: https://github.com/common-again/Qubt-testevhnn#readme
...
`https://common-again.github.io/Qubt-testevhnn`